...
PYBIND11_MODULE(pyIMSRG, m)
{
   ...
   py::class_<TwoBodyChannel>(m, "TwoBodyChannel")
       ...
       .def("GetKetIndex_cc", [](TwoBodyChannel &self)
            { return arma::conv_to<std::vector<int>>::from(self.GetKetIndex_cc()); })
       .def("GetKetIndex_vc", [](TwoBodyChannel &self)
            { return arma::conv_to<std::vector<int>>::from(self.GetKetIndex_vc()); })
       .def("GetKetIndex_qc", [](TwoBodyChannel &self)
            { return arma::conv_to<std::vector<int>>::from(self.GetKetIndex_qc()); })
       .def("GetKetIndex_vv", [](TwoBodyChannel &self)
            { return arma::conv_to<std::vector<int>>::from(self.GetKetIndex_vv()); })
       .def("GetKetIndex_qv", [](TwoBodyChannel &self)
            { return arma::conv_to<std::vector<int>>::from(self.GetKetIndex_qv()); })
       .def("GetKetIndex_qq", [](TwoBodyChannel &self)
            { return arma::conv_to<std::vector<int>>::from(self.GetKetIndex_qq()); })
   ...
   py::class_<TwoBodyME>(m, "TwoBodyME")
       ...
       .def("GetMatrix", [](TwoBodyME &self, int ch)
